            ...
            <div>
                <form id="display" runat="server">
                    <table>
                        ...
                        <tr>
                            <td class="auto-style5">
                                <asp:Button ID="button2" runat="server" OnClick="continuedSubmitButton_Click" Text="Submit" AutoPostBack="true" ValidationGroup="submitValidation"/>
                        </tr>
                    </table>
                    <asp:Label ID="doneMessage2" runat="server" />
                    <asp:Label ID="incompleteMessage1" runat="server" />
                    <asp:GridView ID="infoGridView" runat="server" AutoGenerateColumns="False" OnRowDataBound="ddlClientNameTbx" ShowHeaderWhenEmpty="True" CellPadding="8" CssClass="auto-style6" Width="97%">
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Description 2">
                                <ItemTemplate>
                                    ...
                                    <asp:TextBox runat="server" ID="description2Text" AutoPostBack="true" Text='<%# Bind("Description2") %>' Width="300px" />
                                  <asp:RequiredFieldValidator class="submitValidation" runat="server" ControlToValidate="description2Text" ValidationGroup="submitValidation" ErrorMessage="REQUIRED" ForeColor="Red" Font-Size="XX-Large" InitialValue=""></asp:RequiredFieldValidator>
                                </ItemTemplate>
                                <ControlStyle Font-Bold="True" Font-Names="Arial" Font-Size="11px" />
                                <HeaderStyle Font-Names="Arial Black" Wrap="False" HorizontalAlign="Left" />
                                <ItemStyle Font-Bold="True" Font-Names="Arial" Wrap="False" HorizontalAlign="Center" />
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Client Name"><%--ClientName--%>
                                <ItemTemplate>
                                    ...
                                    <asp:RequiredFieldValidator class="submitValidation" runat="server" ControlToValidate="ddlClientNameText" ValidationGroup="submitValidation" ErrorMessage="REQUIRED"  Font-Size="XX-Large" ForeColor="Red" InitialValue="Please select"></asp:RequiredFieldValidator>
                                </ItemTemplate>
                                <ControlStyle Font-Bold="True" Font-Names="Arial" Font-Size="11px" />
                                <HeaderStyle Font-Names="Arial Black" Wrap="False" HorizontalAlign="Left" />
                            ...
                            <asp:TemplateField HeaderText="Category Description"><%--Category Description--%>
                                <ItemTemplate>
                                    ...
                                    <asp:RequiredFieldValidator class="submitValidation" runat="server" ControlToValidate="ddlCategoryDescriptionText" ValidationGroup="submitValidation" ErrorMessage="REQUIRED" ForeColor="Red" Font-Size="XX-Large" InitialValue="Please select"></asp:RequiredFieldValidator>
                                </ItemTemplate>
                                <ControlStyle Font-Bold="True" Font-Names="Arial" Font-Size="11px" />
                                <HeaderStyle Font-Names="Arial Black" Wrap="False" HorizontalAlign="Left" />
                                <ItemStyle Font-Names="Arial" Font-Bold Wrap="False" Width="280px" />
                            </asp:TemplateField>
