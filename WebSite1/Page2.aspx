            ...
            <div class="auto-style3">
                <form id="display" runat="server" style="margin-left: -20px;" class="auto-style6">
                    <table>
                        ...
                        <tr>
                            <td>
                                <asp:Button Id="button2" runat="server" OnClick="submitButton_Click" Text="Submit" AutoPostBack="true"  ValidationGroup="submitValidation"/>
                        </tr>
                        <tr>
                            <td>
                    ...
                    <asp:GridView ID="infoGridView" runat="server" CellPadding="8" AutoGenerateColumns="False" OnRowDataBound="ddlClientNameTbx" ShowHeaderWhenEmpty ="True" Width="1859px" CssClass="auto-style7" >
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Description 2">
                                <ItemTemplate>
                                    ...
                                    <asp:RequiredFieldValidator class="submitValidation" runat="server" ControlToValidate="description2Text" ValidationGroup="submitValidation" ErrorMessage="REQUIRED" ForeColor="Red" Font-Size="XX-Large" InitialValue="" Width="10px"></asp:RequiredFieldValidator>
                                </ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Client Name"><%--ClientName--%>
                                <ItemTemplate>
                                    ...
                                    <asp:RequiredFieldValidator class="submitValidation" runat="server" ControlToValidate="ddlClientNameText" ValidationGroup="submitValidation" ErrorMessage="REQUIRED" ForeColor="Red" InitialValue="Please select"></asp:RequiredFieldValidator>
                                </ItemTemplate>
                                <ControlStyle Font-Bold="True" Font-Names="Arial" Font-Size="11px" />
                                <HeaderStyle Font-Names="Arial Black" Wrap="False" HorizontalAlign="Left" />
