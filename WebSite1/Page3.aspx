                    ...
                    <table>
                        ...
                        <tr>
                            <td class="auto-style25">
                                <asp:Button ID="button2" runat="server" OnClick="createCsv" Text="Create CSV" AutoPostBack="true" ValidationGroup="submitValidation" />
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style25">
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Description 2">
                                <ItemTemplate>
                                    ...
                                    <asp:RequiredFieldValidator class="submitValidation" runat="server" ControlToValidate="description2Text" ValidationGroup="submitValidation" ErrorMessage="REQUIRED"  Font-Size="XX-Large" ForeColor="Red" InitialValue="Please select"></asp:RequiredFieldValidator>
                                </ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Category Description"><%--Category Description--%>
                                <ItemTemplate>
                                    ...
                                    <asp:DropDownList ID="ddlCategoryDescriptionText" runat="server" AutoPostBack="true" AppendDataBoundItems="true"></asp:DropDownList>
                                     <asp:RequiredFieldValidator class="submitValidation" runat="server" ControlToValidate="ddlCategoryDescriptionText" ValidationGroup="submitValidation" ErrorMessage="REQUIRED" Font-Size="XX-Large" ForeColor="Red" InitialValue="Please select"></asp:RequiredFieldValidator>
                                </ItemTemplate>
                                <ControlStyle Font-Bold="True" Font-Names="Arial" Font-Size="11px" />
                                <HeaderStyle Font-Names="Arial Black" Wrap="False" HorizontalAlign="Left" />
                                <ItemStyle Font-Names="Arial" Font-Bold Wrap="False" />
